...
class App extends React.Component {
  ...
  // Log in function: update the user state
  ...
  // Log out function: reset the value of the user object in local state
  logOut() {
    this.setState({
      user
    })
  ...
  render () {
    ...
    // Wrap the entire app in the AppContext.Provider component created using the provider element & set the value of user and logOut to the user object and logOut using the state
    return(
