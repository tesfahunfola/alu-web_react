...
class App extends React.Component {
  constructor(props) {
    ...
    // Set the listNotifications within the state of the App component
    this.state = {
      displayDrawer: false,
      user,
      logOut: this.logOut,
  ...
  // When it's called, it should remove the notification from the listNotifications
  ...
  render () {
    ...
    <AppContext.Provider value={{user: this.state.user, logOut: this.state.logOut}}>
      {/* Pass the listNotifications to the Notifications component using the state */}
