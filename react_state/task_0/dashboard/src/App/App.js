...
class App extends React.Component {
  constructor(props) {
    ...
    // Define the default state for the displayDrawer
    this.state = {
      displayDrawer: false
    }
  }
  ...
  // Define the function to change the state of the displayDrawer to true
  handleDisplayDrawer() {
    this.setState({
      displayDrawer: true
    })
  ...
  // Define the function to change the state of the displayDrawer to false
  handleHideDrawer() {
    this.setState({
      displayDrawer: false
    })
  ...
  render () {
    // Pass the displayDrawer state to the Notifications component as a prop
